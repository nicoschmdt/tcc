...
def generalize_venue_category(venue_category: str) -> PoiCategory:
    if any(sub_str in venue_category for sub_str in ['Shop', 'Store', 'Restaurant', 'Bakery', 'Wash', 'Embassy', 'Ramen', 'Diner', 'Salon', 'Place', 'Steakhouse', 'Market', 'Joint', 'store', 'Food', 'Service', 'Bar', 'Café', 'Cafe', 'Office', 'Bank', 'Mall', 'Newsstand', 'Fair', 'Tea', 'City', 'Gastropub', 'Studio', 'Bodega', 'Rental', 'Dealership', 'Photography Lab', 'Medical Center']):
        return PoiCategory.Business
    elif any(sub_str in venue_category for sub_str in ['Factory', 'Military', 'Distillery', 'Government', 'Harbor', 'Facility', 'Winery', 'Brewery']):
        return PoiCategory.Industry
    elif any(sub_str in venue_category for sub_str in ['Residential Building', 'Building', 'Shelter', 'Neighborhood', 'Home', 'Hotel', 'Housing', 'House']):
        return PoiCategory.Residence
    elif any(sub_str in venue_category for sub_str in ['Scenery', 'Scenic', 'Park', 'Outdoors', 'Garden', 'Museum', 'Castle', 'River', 'Cemetery', 'Temple', 'Synagogue', 'Church', 'Shrine', 'Historic', 'Mosque', 'Planetarium', 'Spot', 'Rest Area', 'Plaza', 'Spiritual', 'Campground']):
    ...
    elif any(sub_str in venue_category for sub_str in ['Music', 'Movie', 'Playground', 'Arcade', 'Art', 'Entertainment', 'Gym', 'Nightlife', 'Spa', 'Pool', 'Library', 'Aquarium', 'Beach', 'Zoo', 'Bowling', 'Theater', 'Athletic', 'Casino', 'Comedy', 'Stadium', 'Concert', 'Convention', 'Ski', 'Racetrack']):
        return PoiCategory.Entertainment
    elif any(sub_str in venue_category for sub_str in ['Train', 'Bike', 'Airport', 'Ferry', 'Station', 'Road', 'Moving', 'Transport', 'Subway', 'Bridge', 'Travel', 'Taxi', 'Light Rail']):
