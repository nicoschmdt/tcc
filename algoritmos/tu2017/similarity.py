...
if __name__ == "__main__":
    a = TuPoint(name='10', user_id='1', category={PoiCategory.Business}, latitude=0.0, longitude=0.0, utc_timestamp=datetime(2012, 4, 3, 18, 20, 0, tzinfo=timezone.utc), duration=timedelta(seconds=3600))
    b = TuPoint(name='12', user_id='2', category={PoiCategory.Transport}, latitude=9.0, longitude=8.0, utc_timestamp=datetime(2012, 4, 3, 19, 30, tzinfo=timezone.utc), duration=timedelta(0))
